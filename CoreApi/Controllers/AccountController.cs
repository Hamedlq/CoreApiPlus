...
namespace CoreApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //{
        //    IdentityUser user = await UserManager.FindByIdAsync(int.Parse(User.Identity.GetUserId()));
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.UserName,user.Name,user.Family,user.MobileConfimed);
