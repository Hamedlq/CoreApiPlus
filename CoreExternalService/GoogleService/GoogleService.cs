...
namespace CoreExternalService
{
    public class GoogleService : IGoogleService
    {
        ...
        {
            SERVER_API_KEY = ConfigurationManager.AppSettings["MibarimServerAPIKey"];
            SENDER_ID = ConfigurationManager.AppSettings["MibarimSenderId"];
        }

        public string SendTaxiManagerNotification(string deviceId, string message)
        {
            try
            {
                var value = message;
